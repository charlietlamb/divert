...
export const TextRevealCard = ({
  ...
  return (
    <div
      ...
      ref={cardRef}
      className={cn(
        "relative z-10 w-full overflow-hidden rounded-lg border border-slate-700 bg-slate-900 p-8 transition hover:border-slate-200 hover:shadow-xl",
        className,
      )}
    >
      {children}
      ...
      <div className="relative  flex h-40 items-center overflow-hidden">
        <motion.div
          ...
          className="absolute z-20 bg-slate-900  will-change-transform"
        >
          <p
            style={{
