...
export default function HeroTop() {
  return (
    ...
    >
      <motion.h2
        className="title-width title-size-small relative text-center font-bold text-slate-200"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
        We help ecom companies{" "}
        ...
        their average order value and lower their cost per acquisition at scale
      </motion.h2>
      <motion.h3
      ...
      >
        ...
        <span className="relative">
          <span className="relative z-10">
            penny
            <Squiggle2 className="absolute -bottom-1 left-0 w-full max-w-full" />
          </span>
        </span>{" "}
        on ads
      </motion.h3>
